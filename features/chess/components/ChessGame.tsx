...
export default function ChessGame() {
  ...
  if (!mode) {
    return (
      <div className="flex min-h-screen items-start justify-center overflow-y-auto px-6 py-8 lg:h-screen lg:items-center lg:overflow-hidden">
  ...
  return (
    <div className="min-h-screen w-full overflow-x-hidden overflow-y-auto bg-[#0B0F14] px-4 py-4 lg:h-screen lg:overflow-hidden">

      <div className="mx-auto flex h-full w-full max-w-[1500px] flex-col items-center justify-center gap-4 lg:grid lg:grid-cols-[220px_minmax(0,540px)_280px] lg:items-center lg:gap-8">

        {/* LEFT PANEL DESKTOP */}
        <div className="hidden lg:flex lg:flex-col lg:gap-4">

          <div className="rounded-[28px] border border-white/10 bg-[#151A22]/90 p-6">
            ...
            {gameMode === 'local' ? (
              ...
              <span className="rounded-full bg-[#A78BFA]/10 px-4 py-2 text-sm capitalize text-[#A78BFA]">
                {aiDifficulty}
              </span>
            )}
          </div>
          ...
          <div className="rounded-[28px] border border-white/10 bg-[#151A22]/90 p-6">
            ...
            {gameMode === 'local' ? (
              ...
              <span className="rounded-full bg-[#8FB8A8]/10 px-4 py-2 text-sm text-[#8FB8A8]">
                Practice
              </span>
            )}
          </div>
        ...
        <div className="flex w-full flex-col items-center">
          ...
          <div className="mb-4 text-center">
            <h1 className="text-5xl font-bold tracking-[-0.06em] lg:text-6xl">
              Knightly
            </h1>
          ...
          {/* BOARD */}
          <div className="rounded-[32px] border border-white/10 bg-[#151A22]/90 p-3 shadow-[0_20px_80px_rgba(0,0,0,0.35)]">
        ...
        {/* COACH PANEL */}
        <div className="w-full max-w-[420px] lg:max-w-none lg:w-[280px]">

          <div className="rounded-[28px] border border-white/10 bg-[#151A22]/90 p-5">
            ...
            <div className="mb-5 flex items-start justify-between">
              ...
              <div className="relative">
                ...
                {showMenu && (
                  <div className="absolute right-0 top-14 z-50 flex w-44 flex-col rounded-[24px] border border-white/10 bg-[#1C2430] p-2 shadow-xl">
            ...
            {enabled ? (
              <>
                <p className="text-sm leading-7 text-[#CBD5E1]">
                  {coachingText ??
                    'Your coach will give move feedback here.'}
                </p>
